...
//         document.title = "Portfolio | Avinash Dhanuka";
//         $("#favicon").attr("href","assests/images/favicon-16x16.png");
//     }
//     else {
...
$("#contact-form").submit(function (event) {
    ...
    emailjs.sendForm('service_zgq58qi', 'template_hl632gn', '#contact-form')
